...
--
-- Host: 127.0.0.1
-- Tempo de geração: 16-Nov-2020 às 14:32
...
(1, 'Thiago Luis', 'Rua Aurelio Cavalcante', 'Gruta de Lourdes', '82996049606', 'martins.luisthiago@gmail.com', 147),
(2, 'Maria da Silva', 'Rua do centro', 'Feitosa', '82 996039632', 'maria@gmail.com', 1),
(3, 'Fernanda Ribeiro Pereira', 'Marginal São Leopoldo', 'Bom Fim', '980763997', 'fernandapereira@localhost.com', 183),
(4, 'Sarah Freitas Moura', 'Praça Caçador', 'Anchieta', '06120133644', 'sarah@localhost.com', 1443);
...
--
-- AUTO_INCREMENT de tabela `famosos`
--
ALTER TABLE `famosos`
...
--
ALTER TABLE `pessoa`
  ADD CONSTRAINT `fk_cidades` FOREIGN KEY (`id_cidade`) REFERENCES `cidades` (`id`);
COMMIT;
